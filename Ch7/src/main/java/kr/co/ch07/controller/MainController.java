...
public class MainController {
	...
	public String query1() {
		User1VO user =repo.findUser1VOByUid("A105");
		System.out.println("query1 결과 : "+user);
		return "redirect:/";
	}
	@GetMapping("/query2")
	public String query2() {
		List<User1VO> users =repo.findUser1VOByName("이순진");
		System.out.println("query2 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query3")
	public String query3() {
		List<User1VO> users = repo.findUser1VOByNameNot("이순진");
		System.out.println("query3 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query4")
	public String query4() {
		List<User1VO> users =  repo.findUser1VOByUidAndName("A105","이순진");
		System.out.println("query4 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query5")
	public String query5() {
		List<User1VO> users =  repo.findUser1VOByUidOrName("A102", "이순진");
		System.out.println("query5 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query6")
	public String query6() {
		List<User1VO> users= repo.findUser1VOByAgeGreaterThan(29);
		System.out.println("query6 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query7")
	public String query7() {
		List<User1VO> users = repo.findUser1VOByAgeGreaterThanEqual(29);
		System.out.println("query7 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query8")
	public String query8() {
		List<User1VO> users = repo.findUser1VOByAgeLessThan(29);
		System.out.println("query8 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query9")
	public String query9() {
		List<User1VO> users= repo.findUser1VOByAgeLessThanEqual(29);
		System.out.println("query9 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query10")
	public String query10() {
		List<User1VO> users = repo.findUser1VOByNameLike("멋쟁이");
		System.out.println("query10 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query11")
	public String query11() {
		List<User1VO> users =  repo.findUser1VOByNameContains("쟁이");
		System.out.println("query11 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query12")
	public String query12() {
		List<User1VO> users =  repo.findUser1VOByNameStartsWith("멋");
		System.out.println("query12 결과 : "+users);
		return "redirect:/";
	}
	@GetMapping("/query13")
	public String query13() {
		List<User1VO> users =  repo.findUser1VOByNameEndsWith("쟁이");
	...
	public String query18() {
		int result = repo.countUser1VOByUid("A104");
		System.out.println("query18 결과 : "+result);
		return "redirect:/";
	}
	@GetMapping("/query19")
	public String query19() {
		int result = repo.countUser1VOByName("장보고");
		System.out.println("query19 결과 : "+result);
		return "redirect:/";
	}
	@GetMapping("/query20")
